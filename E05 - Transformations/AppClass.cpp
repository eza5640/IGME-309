...
void Application::Display(void)
{
	...
	matrix4 m4Translate = glm::translate(IDENTITY_M4, vector3(0.f + value, 0.0f, 0.0f));
	value += 0.01f;
	...
	m4Translate = glm::translate(IDENTITY_M4, vector3(-5.0f + value, -1.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh25->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(5.0f + value, 0.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh26->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(5.0f + value, -1.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh27->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(0.0f + value, 2.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh28->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(-1.0f + value, 2.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh29->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(1.0f + value, 2.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh30->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(3.0f + value, 2.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh31->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(-3.0f + value, 2.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh32->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(4.0f + value, 2.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh33->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(-4.0f + value, 2.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh34->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(-1.0f + value, 3.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh35->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(-2.0f + value, 3.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh36->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(-3.0f + value, 3.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh37->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(1.0f + value, 3.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh38->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(2.0f + value, 3.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh39->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(3.0f + value, 3.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh40->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(0.0f + value, 3.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh41->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(-2.0f + value, 4.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh42->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(2.0f + value, 4.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh43->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(3.0f + value, 5.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh44->Render(m4Projection, m4View, m4Model);

	m4Translate = glm::translate(IDENTITY_M4, vector3(-3.0f + value, 5.0f, 0.0f));
	m4Model = m4Scale * m4Translate;
	m_pMesh45->Render(m4Projection, m4View, m4Model);
