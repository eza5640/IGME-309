...
class MyCamera
{
	...
	vector3 m_v3Target = vector3(0.0f, 0.0f, 9.0f); //What I'm looking at
...
public:
	...
	*/
	...
	/*
	USAGE: Sets the position of the forward of the camera
	ARGUMENTS: vector3 a_v3Forward -> The point that is forward
	OUTPUT: ---
	*/
	void SetForward(vector3 a_v3Forward);

	/*
	USAGE: Gets the position of the forward of the camera
	ARGUMENTS: ---
